...
class Gui(Tk):
    ...
    def __add_sentence_label(self):
        ...
        self.sentence_label.grid(row=2, column=1, columnspan=2)
    ...
    def __add_email_label(self):
        ...
        self.email_label.grid(row=3, column=1, columnspan=2)
    ...
    def __add_email_entry(self):
        ...
        self.email_entry.grid(row=4, column=2, columnspan=2)
        self.email_entry.place(x=150,y=105)

    def __add_subscribe_button(self):
        self.subscribe_button = Button()
        self.subscribe_button.grid(row=5, column=4, columnspan=2)
