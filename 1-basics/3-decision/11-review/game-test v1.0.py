...
####################################################################################
print("Question 4:What is the richest plannet in the universe")
q4 = input()
if (q4 == "Apple"):
    print("Correct you gained a life")
    life +=1
...
if (q3 == "8"):
    ...
    if (life == 0):
        ...
        print("Life","♥"*life)
###################################################################################
print("You won,",name,"with",correct_answer,"correct answers and",incorrect_answer,"incorect answers")